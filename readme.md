...
Although it is hosted on the free teir of render so when you open the link if its broken dont worry, after a minute for the server should have started up. Reload the page and it should work 😄
